...
Original file is located at
    https://colab.research.google.com/drive/1DKI16S2WUqsO2XzVm2_mRqHNDrNlDDA0
"""
...
e2 = 65537
N2= 70212284026476551287497867344660173062242619935306997607985987428352052911293
c2 = 60400943706823506830284280114139818288715016023417103465230780522075862090739


#creating a list of possible passwords
passwords = []
for a in range(100,1000):
  temp = "0" + str(a)
  passwords.append(int(temp))
...
#determining the password by brute force
for i in passwords:
  for j in range(0,256):
    if c2==RSA_OAEP_Enc(i,e2,N2,j):
      print("The 4 digit password is: ", i)