...
Original file is located at
    https://colab.research.google.com/drive/1MaB8AmpWvRjBIdFk1vhwl2IlvXVKeqsA
"""
...
b= 



(message1, r1, s1) = (b"He who laugh last didn't get the joke", 867552604169477346883674422144796797059303863627, 243861349833858115605937030382497401412336608822)
(message2,r2 , s2) = (b"Ask me no questions, and I'll tell you no lies", 686145019080375810998084468514665120375929537329, 774583422188330317252601038183072854135396118762)
k = random.randint(0, q-1)

#find the hash value to solve the equation k2=k1*x %q
shake1 = SHAKE128.new(message1)
h1 = int.from_bytes(shake1.read(q.bit_length()//8), byteorder='big')
print("First hash value is :", h1)
shake2 = SHAKE128.new(message2)
h2 = int.from_bytes(shake2.read(q.bit_length()//8), byteorder='big')
print("Second hash value is : ",h2)
a= ((s1*h2)-(s2*h1*2))* (modinv(((s2*r1*2)-(s1*r2)),q)) %q
print("The secret key is: ",a)

#check if the key is correct by checking beta value
if pow(g,a,p) == b:
  print("It works!")